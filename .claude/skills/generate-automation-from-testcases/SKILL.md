...
description: Convert manual test cases into automation scripts autonomously using the 6-step AI-RBT Framework and Claude Code tools.
---
...
2. **Theo dõi kết quả** qua `BashOutput`:
