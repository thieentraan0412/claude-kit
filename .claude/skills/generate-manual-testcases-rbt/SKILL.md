...
> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`/rbt-manual-testing`** (tại `.claude/skills/rbt-manual-testing/SKILL.md`) trước khi bắt đầu thực hiện tác vụ này. Sử dụng **Mode FULL RBT** của skill. Ngoài ra, tham khảo thêm skill **`/requirements-analyzer`** để hiểu cách phân tích giao diện nếu cần.
...
> [!NOTE]
> **Luồng này là một skill.** Thực hiện theo hướng dẫn trong skill, không cần đọc file `prompt.txt`.
