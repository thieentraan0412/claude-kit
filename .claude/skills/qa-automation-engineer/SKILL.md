...
When the user request matches a specific task, select the appropriate workflow skill from `.claude/skills/`.
...
- `.claude/rules/delivery_checklist.md` — Quality checklist / Definition of Done
