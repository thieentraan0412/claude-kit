...
> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`/jira-integration`** (tại `.claude/skills/jira-integration/SKILL.md`) để biết cách sử dụng scripts trước khi bắt đầu.
